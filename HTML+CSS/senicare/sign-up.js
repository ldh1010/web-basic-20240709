...
var userPasswoedCheckElement = document.getElementById('user-password-check');
...
var userPasswoedCheckMessageElement = document.getElementById('user-password-check-message');
