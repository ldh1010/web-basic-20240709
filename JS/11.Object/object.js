...
*/
console.log(leedonghoon.age);
console.log(leedonghoon['age']);
console.log(leedonghoon[age]);
console.log(leedonghoon['first name']);

var property = 'last-name';
console.log(leedonghoon[property]);
...
/*
    ...
    - 문자열로된 속성의 키가 반환됨
*/
for (var key in leedonghoon) {
    console.log(leedonghoon[key]);
}
